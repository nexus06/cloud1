...
public class AcronymProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri,
        ...
        case ACRONYMS:
            ...
            long id = mOpenHelper.getWritableDatabase().insert(AcronymContract.PATH_ACRONYM, null, values);
        ...
        case ACRONYMS:
            ...
            try {
            	...
            	for (ContentValues value : contentValues) {
                    final long id =
                        db.insert(AcronymContract.PATH_ACRONYM,
                                  null,
                                  value);
                    if (id != -1)
                        returnCount++;
    ...
    public Cursor query(Uri uri,
        ...
        case ACRONYMS: 
        	...
        	queryBuilder.setTables(AcronymContract.PATH_ACRONYM);
        ...
        case ACRONYM: 
            ...
            final SQLiteQueryBuilder queryBuilder2 =
                    new SQLiteQueryBuilder();
                	queryBuilder2.setTables(AcronymContract.PATH_ACRONYM);
                	retCursor = queryBuilder2.query(mOpenHelper.getReadableDatabase(),
                                       projection,
                                       rowId,
                                       selectionArgs,
                                       null,	// GROUP BY (not used)
    ...
    public int update(Uri uri,
        ...
        case ACRONYMS:
            ...
            rowsUpdated = 
                    db.update(AcronymContract.PATH_ACRONYM,
                            values,
                            selection,
                            selectionArgs);
            break;
    ...
    public int delete(Uri uri,
        ...
        case ACRONYMS:
            ...
            rowsDeleted = db.delete(AcronymContract.PATH_ACRONYM,
            		selection,
            		selectionArgs);
            break;
        default:
